...
NetworkTopology NetworkTopologyServices::generateNetwork() {
    ...
    add_edge(v1, v2, EdgePropertyData{150.0 / 1000, 0.001 * 1000}, g);
    add_edge(v2, v1, EdgePropertyData{150.0 / 1000, 0.001 * 1000}, g);

    add_edge(v1, v3, EdgePropertyData{36.0 / 1000, 0.07 * 1000}, g);
    add_edge(v3, v1, EdgePropertyData{36.0 / 1000, 0.07 * 1000}, g);

    add_edge(v1, v4, EdgePropertyData{150.0 / 1000, 0.001 * 1000}, g);
    add_edge(v4, v1, EdgePropertyData{150.0 / 1000, 0.001 * 1000}, g);

    add_edge(v1, v5, EdgePropertyData{150.0  / 1000, 0.001 * 1000}, g);
    add_edge(v5, v1, EdgePropertyData{150.0  / 1000, 0.001 * 1000}, g);

    add_edge(v2, v3, EdgePropertyData{1024.0 / 1000 , 0.02 * 1000}, g);
    add_edge(v3, v2, EdgePropertyData{1024.0 / 1000, 0.02 * 1000}, g);

    add_edge(v2, v4, EdgePropertyData{1024.0 / 1000, 0.01 * 1000}, g);
    add_edge(v4, v2, EdgePropertyData{1024.0 / 1000, 0.01 * 1000}, g);

    add_edge(v2, v5, EdgePropertyData{1024.0 / 1000, 0.01 * 1000}, g);
    add_edge(v5, v2, EdgePropertyData{1024.0 / 1000, 0.01 * 1000}, g);

    add_edge(v3, v4, EdgePropertyData{1024.0 / 1000, 0.02 * 1000}, g);
    add_edge(v4, v3, EdgePropertyData{1024.0 / 1000, 0.02 * 1000}, g);

    add_edge(v3, v5, EdgePropertyData{1024.0 / 1000, 0.02 * 1000}, g);
    add_edge(v5, v3, EdgePropertyData{1024.0 / 1000, 0.02 * 1000}, g);

    add_edge(v4, v5, EdgePropertyData{1024.0 / 1000, 0.01 * 1000}, g);
    add_edge(v5, v4, EdgePropertyData{1024.0 / 1000, 0.01 * 1000}, g);
